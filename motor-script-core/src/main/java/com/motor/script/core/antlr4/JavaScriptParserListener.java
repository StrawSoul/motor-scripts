...
public interface JavaScriptParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link JavaScriptParser#sqlBodyItem}.
	 * @param ctx the parse tree
	 */
	void enterSqlBodyItem(JavaScriptParser.SqlBodyItemContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaScriptParser#sqlBodyItem}.
	 * @param ctx the parse tree
	 */
	void exitSqlBodyItem(JavaScriptParser.SqlBodyItemContext ctx);
	/**
	 * Enter a parse tree produced by {@link JavaScriptParser#sqlBody}.
	 * @param ctx the parse tree
	 */
	void enterSqlBody(JavaScriptParser.SqlBodyContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaScriptParser#sqlBody}.
	 * @param ctx the parse tree
	 */
	void exitSqlBody(JavaScriptParser.SqlBodyContext ctx);
	/**
	 * Enter a parse tree produced by {@link JavaScriptParser#sqlDeclaration}.
	 * @param ctx the parse tree
	 */
	void enterSqlDeclaration(JavaScriptParser.SqlDeclarationContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaScriptParser#sqlDeclaration}.
	 * @param ctx the parse tree
	 */
	void exitSqlDeclaration(JavaScriptParser.SqlDeclarationContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link JavaScriptParser#memberPropertyName}.
	 * @param ctx the parse tree
	 */
	void enterMemberPropertyName(JavaScriptParser.MemberPropertyNameContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaScriptParser#memberPropertyName}.
	 * @param ctx the parse tree
	 */
	void exitMemberPropertyName(JavaScriptParser.MemberPropertyNameContext ctx);
	/**
