...
public interface JavaScriptParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link JavaScriptParser#sqlBodyItem}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSqlBodyItem(JavaScriptParser.SqlBodyItemContext ctx);
	/**
	 * Visit a parse tree produced by {@link JavaScriptParser#sqlBody}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSqlBody(JavaScriptParser.SqlBodyContext ctx);
	/**
	 * Visit a parse tree produced by {@link JavaScriptParser#sqlDeclaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSqlDeclaration(JavaScriptParser.SqlDeclarationContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link JavaScriptParser#memberPropertyName}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMemberPropertyName(JavaScriptParser.MemberPropertyNameContext ctx);
	/**
